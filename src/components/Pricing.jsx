    ...
    <div name='pricing' className='w-full text-white my-24'>
      ...
      <div className='max-w-[1240px] mx-auto py-12'>
        ...
        <div className='text-center py-8 text-slate-300'>
          ...
          <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed nesciunt porro dignissimos quas incidunt. Ex doloremque laborum reprehenderit vero debitis.</p>
        </div>

        <div className='grid md:grid-cols-2'>

          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            <span className='uppercase px-3 py-1 bg-indigo-200 text-indigo-900 rounded-lg text-sm'>Standard</span>
            <div>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            <span className='uppercase px-3 py-1 bg-indigo-200 text-indigo-900 rounded-lg text-sm'>Premium</span>
            <div>
